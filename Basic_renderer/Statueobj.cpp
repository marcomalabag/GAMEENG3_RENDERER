...
Statueobj::Statueobj(String name, void* shaderByteCode, size_t sizeShader)
{
	this->MyMesh = GraphicsEngine::get()->getMeshManager()->createMeshFromFile(L"Assets\\Meshes\\statue.obj");
...
void Statueobj::update(float deltaTime)
{
...
void Statueobj::draw(int width, int height)
{
	constant cc;
...
void Statueobj::setAnimSpeed(float speed)
{
	this->speed = speed;
}
