...
VertexBufferWithoutTexturePtr RenderSystem::createVertexBufferWithoutTexture(void* list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, UINT size_byte_shader)
{
	VertexBufferWithoutTexturePtr vbwt = nullptr;
	try {
		vbwt = std::make_shared<VertexBufferWithoutTexture>(list_vertices, size_vertex, size_list, shader_byte_code, size_byte_shader, this);
	}
	catch (...) {}
	return vbwt;
}
