...
public:
	...
	VertexBufferWithoutTexturePtr createVertexBufferWithoutTexture(void* list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, UINT size_byte_shader);
...
private:
	...
	friend class VertexBufferWithoutTexture;
};
