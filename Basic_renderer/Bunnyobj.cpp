...
Bunnyobj::Bunnyobj(String name, void* shaderByteCode, size_t sizeShader) :AGameObject(name)
{
	this->MyMesh = GraphicsEngine::get()->getMeshManager()->createMeshFromFile(L"Assets\\Meshes\\stanford-bunny.obj");
...
void Bunnyobj::update(float deltaTime)
{
...
void Bunnyobj::draw(int width, int height)
{
	constant cc;
...
void Bunnyobj::setAnimSpeed(float speed)
{
	this->speed = speed;
}
